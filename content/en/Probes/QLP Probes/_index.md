...
2. Integrated temperature sensor close to the sample space for acturate temperature determintation
3. Direct WR-28 waveguide connection
4. Iris adjustment. The QLP probe head is avaiable either with a remote controlled or manually controlled iris <sup>(1)</sup>
...
3. Free-space perpendicular to the sample axis. The probe has a small window (1.5 mm diameter) for direct light access. The locatio of the window is compatible with the location of the window of the cryostat.
...
<sup>(1)</sup>. By default the probe is delivered with remote control of the iris, which is compatible with the [Compact-Q]() or the [Elexsys E580]() series pulsed EPR spectromters.
