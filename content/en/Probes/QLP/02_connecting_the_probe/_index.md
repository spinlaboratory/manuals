...
5. Once the waveguide is connected, connect the temperature sensor to the temperature controller.

### What's next? ###
* Learn about [Inserting the Sample](/probes/bridge12-qlp/03_inserting_sample/).