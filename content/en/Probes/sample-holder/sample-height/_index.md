...
type:           docs
date:           2023-02-14
description:    "Recommended sample amount and position for optimum performance"
---
...
| Resonator <br> Model | Sample Tube  OD | Recommended <br> Sample Height (mm) | Distance to <br> Sample Center |
| ---------------------|:---------------:|-------------------------------------|:------------------------------:|
| QLP                  | 1.6 mm          | > 5 mm <br> (4.8 &mu;l sample volume)| 25.4 mm<sup>(1)</sup>         |

###### Footnotes ######
<sup>(1)</sup> Early prototype versions of the QLP resonator use 12 mm as the distance to sample center.
 ...
 * [Probe-Description](/docs/probe-description/): Get started with $project
* [References](/docs/references/): Check out some example code! -->