...
---
The Bruker AMP-Q40 is a 40 W solid-state microwave amplifier for Q-Band (35 GHz) pulsed EPR spectroscopy. The amplifier can fully replace a TWT amplifier and in combination with the [Bruker QLP-1.6 probe ](https://www.bridge12.com/products/q-band-pulsed-epr-resonator/) is a great combination for pulsed dipolar EPR spectroscopy.

{{% pageinfo %}}
### Note ###
The expected pulse length for a 180Âº-pulse, using a maximally overcoupled [Bruker QLP-1.6 resonator](https://www.bridge12.com/products/q-band-pulsed-epr-resonator/) is 16 ns.
{{% /pageinfo %}}
...
The Bruker AMP-Q40 can fully replace a TWT amplifier. The following connection to the spectrometer need to be made:
...
2. **Microwave Output (OUT):** Output connection of the amplifier. This either needs to be connected to the circulator extension (Bruker Q-Band spectrometer) or to the input of the EPR bridge. If you are unsure please contact Bruker at epr-applications@bruker.com. If your EPR bridge requires a 2.92 mm input connection, we recommend installing a [waveguide to coax adapter](https://www.eravant.com/wr-28-waveguide-to-v-f-coax-adapter-right-angle-5g). 
